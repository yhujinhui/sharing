            ...
            <div>
                ...
                <form name="test" method="post" action="trialTestProc.php" onsubmit="return checksubmit();">
                    ...
                    <div>
                        ...
                        <input type="radio" name="Q2" value="C"> 소수 가까운 친구 모임 <br>
                        <input type="radio" name="Q2" value="D"> 나는 외로운 늑대, 모임이 싫다 <br>
                        <input type="radio" name="Q2" value="E"> 새로운 친구 모임
                    </div>
    
                    <div>
                        <div>모임에서 친구가 같은 옷을 입고 왔습니다. 어떻게 할건가요? </div>
                        <input type="radio" name="Q3" value="A"> 전혀 신경쓰지 않는다  <br>
                        <input type="radio" name="Q3" value="B"> 당혹스럽지만 어쩔 수 없다 <br>
                        <input type="radio" name="Q3" value="C"> 그냥 내가 옷을 갈아 입는다 <br>
                        <input type="radio" name="Q3" value="D"> 그냥 집으로 돌아간다 <br>
                        <input type="radio" name="Q3" value="E"> 게임을 해서 한명이 옷을 바꾼다
                    </div>
                    
                    <div>
                        <div>모임에서 보통 당신의 행동은?</div>
                        <input type="radio" name="Q4" value="A"> 있는 듯 없는 듯 조용히 있는다 <br>
                        <input type="radio" name="Q4" value="B"> 필요한 경우에는 의견을 말한다 <br>
                        <input type="radio" name="Q4" value="C"> 다른 사람 말에 호응을 잘 한다 <br>
                        <input type="radio" name="Q4" value="D"> 화려한 입담으로 분위기를 주도 <br>
                        <input type="radio" name="Q4" value="E"> 리드하고 중심적인 역할
                    </div>
    
                    <div>
                        <div>다음 중 가장 안 좋은 것은? </div>
                        <input type="radio" name="Q5" value="A"> 나는 너무 조용하다 <br>
                        <input type="radio" name="Q5" value="B"> 나는 게으르다 <br>
                        <input type="radio" name="Q5" value="C"> 나는 서툴다 <br>
                        <input type="radio" name="Q5" value="D"> 나는 불안정하다 <br>
                        <input type="radio" name="Q5" value="E"> 나는 완벽하다
                    </div>
    
                    <div>
                        <div>화를 자주내는 편인가요? </div>
                        <input type="radio" name="Q6" value="A"> 화를 내는 건 좋지 않아요 <br>
                        <input type="radio" name="Q6" value="B"> 웬만하면 화가 나지 않아요 <br>
                        <input type="radio" name="Q6" value="C"> 가끔 화가 날 때가 있어요 <br>
                        <input type="radio" name="Q6" value="D"> 주변에서 저를 화나게 하네요 <br>
                        <input type="radio" name="Q6" value="E"> 생각만 해도 자주 화가 나요
                    </div>
    
                    <div>
                        <div>금요일이나 토요일 밤엔 주로 무엇을 하시나요? </div>
                        <input type="radio" name="Q7" value="A"> 약속이 있을 때만 외출 <br>
                        <input type="radio" name="Q7" value="B"> 무리를 모아 다같이 외출 <br>
                        <input type="radio" name="Q7" value="C"> 뽐내기 위해 그냥 나감 <br>
                        <input type="radio" name="Q7" value="D"> 가급적 집에 있음 <br>
                        <input type="radio" name="Q7" value="E"> 혼자 밖에 나가 어슬렁거림
                    </div>
    
                    <div>
                        <div>하고 있거나, 앞으로 하고 싶은 운동은 무엇인가요? </div>
                        <input type="radio" name="Q8" value="A"> 테니스나 탁구 <br>
                        <input type="radio" name="Q8" value="B"> 볼링, 골프, 야구 <br>
                        <input type="radio" name="Q8" value="C"> 조깅, 마라톤 <br>
                        <input type="radio" name="Q8" value="D"> 축구나 농구 <br>
                        <input type="radio" name="Q8" value="E"> 권투나 격투기
                    </div>
    
                    <div>
                        <div>당신은 유럽에 도착했어요. 무얼 타고 여행하는 걸 선호하나요? </div>
                        <input type="radio" name="Q9" value="A"> 버스 <br>
                        <input type="radio" name="Q9" value="B"> 자전거 <br>
                        <input type="radio" name="Q9" value="C"> 기차 <br>
                        <input type="radio" name="Q9" value="D"> 비행기 <br>
                        <input type="radio" name="Q9" value="E"> 자동차
                    </div>
    
                    <div>
                        <div>최근 당신 감정과 가장 가까운 것은 무엇인가요? </div>
                        <input type="radio" name="Q10" value="A"> 두려움 <br>
                        <input type="radio" name="Q10" value="B"> 사랑 <br>
